...
2. Open Ganache and start a new workspace or use an existing one.
...
8. Retrieve the Contract ABI and Update the ABI
...
9. Update the Contract Address in the React App
...
Enter the Shipment ID, the Damaged Quantity, and an Explanation for Damages.
...
The shipment information will be displayed. This includes:
- Shipment ID
- Origin of the shipment
- Destination of the shipment
- Quantity of product on shipment
- Total quantity of reported damages
- Damage Reporters & Quantity will display the amount of product reported as damaged by each account and the reason they gave
- Status of shipment (e.g. In Transit, Delivered, etc.)
...
Shipment Details Not Updating:

If you have updated a shipment (reported damages, progressed it to next station, etc.) and the change isn't automatically reflected in the View Shipment Details portion, switch the currently selected Shipment ID to a different ID then switch it back. The shipment details should now properly reflect the updates.
